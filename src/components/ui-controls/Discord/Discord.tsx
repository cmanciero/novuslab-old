...
const Discord: React.FunctionComponent<IDiscord> = (props: IDiscord) => {
	const { logoColor, width, link } = props;
	return (
		<>
			<a href={link} rel='noreferrer' className={`${width}`}>
				<svg viewBox='0 0 25 24' xmlns='http://www.w3.org/2000/svg' className={`fill-current ${logoColor}`}>
					<path
						data-v-54e46119=''
						fillRule='evenodd'
						clipRule='evenodd'
